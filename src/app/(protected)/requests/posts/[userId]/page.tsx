...
export default function Profile() {
  ...
  return (
    <div className={`bg-card rounded-xl w-11/12 md:w-9/12 mx-auto mb-5`}>
      <div
        className={`p-10 md:p-10 rounded-t-xl bg-muted text-card-foreground`}
      >
        <div className={`flex flex-col md:flex-row md:justify-between`}>
          <div className={`flex flex-row items-start gap-4 mb-5`}>
            <Avatar
              className={`size-20 md:size-40 bg-sidebar p-2 rounded-full`}
            >
              <AvatarImage
                className={``}
        ...
        <div className={`flex items-center gap-1.5 flex-wrap`}>
          {(Array.isArray(profile.skills) ? profile.skills : []).map(
            (
              ...
              return (
                <p
                  className={`px-3 py-1 rounded-full bg-input hover:bg-input/80 transition-colors text-sm`}
                  key={index}
                >
                  {skill.label}
                </p>
      ...
      <div
        className={`p-10 md:p-10 rounded-b-xl bg-input text-input-foreground dark:bg-card dark:text-card-foreground`}
      >
