...
export default function Home() {
  ...
  return (
    <div className={`min-h-screen bg-background`}>
      {/* Navbar */}
      <div
        className={`sticky top-0 left-0 m-3.5 rounded-3xl bg-background/5 backdrop-blur-lg flex items-center p-3.5 justify-between`}
      >
        <Button
          variant={`outline`}
          size={`icon`}
        ...
        <h1
          className={`text-3xl font-semibold font-sans text-foreground mr-auto lg:mr-0`}
        >
          Connect
        </h1>
      ...
      {/* Hero Section */}
      <div
        className={`mt-20 w-5/6 mx-auto flex flex-col lg:flex-row lg:items-center `}
      >
        <div className={`w-full lg:w-1/2`}>
          <h1
            className={`text-5xl/15 lg:text-7xl/20 font-semibold font-sans text-foreground text-left`}
          >
            Find your{" "}
            <span className={`font-serif font-normal italic`}>Perfect</span>{" "}
            Project Partner
          </h1>
        ...
        <div className={`w-full lg:w-1/2 flex lg:justify-end items-center`}>
          <Card className={`w-full lg:w-9/12`}>
            <CardContent>
              <CardDescription className={`flex items-center gap-1 mb-5`}>
              ...
              <p className={`text-card-foreground/90 mt-4`}>
                Connect helped me find the perfect teammates for my science fair
                project, leading us to win first place!
              </p>
            </CardContent>
            <CardFooter>
              <p className={`px-3 py-1 rounded-md bg-white/10 text-sm`}>
                High School Junior
              </p>
            </CardFooter>
          </Card>
      ...
      <div className={`my-20 w-5/6 mx-auto rounded-xl bg-card p-15`}>
        ...
        >
          <p className={`text-5xl font-sans text-card-foreground lg:w-7/12`}>
            Collaborate to elevate your potential
          </p>
          <div className={`lg:w-5/12 flex items-center justify-center`}>
            <p
              className={`lg:w-5/6 mt-5 lg:mt-0 text-card-foreground/85 text-sm`}
            >
              Connect empowers high school students to find the perfect
              teammates, transforming individual aspirations into shared
              successes.
            </p>
          </div>
        </div>
        <div className={`grid grid-cols-1 lg:grid-cols-3 gap-12 mt-15`}>
          <div className={`flex flex-col gap-1`}>
            <Users size={30} />
            <p className={`mt-2 text-xl font-semibold font-sans text-white`}>
              Smart Matching
            </p>
            <p className={`text-card-foreground/90`}>
              Our AI-powered matching algorithm analyzes your preferences,
              skills, and interests to find the perfect project partners.
            </p>
          </div>
          <div className={`flex flex-col gap-1`}>
            <Target size={30} />
            ...
            <p className={`text-card-foreground/90`}>
              From ISEF research to hackathons and nonprofits, find partners for
              any project type.
            </p>
          </div>
          <div className={`flex flex-col gap-1`}>
            ...
            <p className={`text-card-foreground/90`}>
              Connect with students who have competition experience and verified
              achievements.
            </p>
          </div>
        </div>
      ...
      <div className={`mb-20 w-5/6 mx-auto`}>
        <p
          className={`lg:text-5xl/14 font-sans text-card-foreground text-center text-4xl/12 lg:text-left lg:w-8/12`}
        >
          Produce innovative solutions with the perfect teammates.
        </p>
        <div className={`grid grid-cols-1 lg:grid-cols-3 gap-5 mt-7.5`}>
          <div className={`flex flex-col gap-3 bg-card p-5 rounded-xl w-full`}>
            <div className={`flex items-center justify-between`}>
              ...
              <p
                className={`px-3 py-1 font-medium flex items-center justify-center rounded-full bg-foreground text-background text-xl`}
              >
                1
              </p>
            </div>
      ...
      <div className={`mb-20 w-9/12 mx-auto`}>
        <p
          className={`text-4xl lg:text-5xl font-sans text-foreground text-center`}
        >
          Why Choose Connect
        </p>
        <div className={`grid grid-cols-2 gap-5 mt-7.5`}>
          <div
            className={`col-span-2 lg:col-span-1 bg-card border border-border rounded-xl p-7.5`}
          >
            <p className={`text-7xl font-sans mb-7.5 text-primary`}>3k+</p>
            <p className={`text-xl text-card-foreground`}>
              Members already collaborating on Connect
            </p>
          </div>
          <div
            className={`col-span-2 lg:col-span-1 bg-card border border-border rounded-xl p-7.5`}
          >
            <p className={`text-xl text-card-foreground mb-8.5`}>
              Instantly connect with your matches through their shared contact
              info.
            </p>
          ...
          <div
            className={`bg-card border border-border rounded-xl p-7.5 col-span-2 flex flex-col lg:flex-row lg:items-start gap-13`}
          >
            <div className={`lg:w-5/12`}>
              <p className={`text-4xl/13 text-card-foreground mb-1.5`}>
                Grow your network.
              </p>
              <p className={`text-base text-card-foreground`}>
                Connect with ambitious peers and watch your skills and projects
                flourish as you team up with the right individuals.
              </p>
            </div>
            <div className={`lg:w-6/12 max-h-[200px] overflow-hidden`}>
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Showing total over the last 6 months
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <ChartContainer
      ...
      {/* Final CTA */}
      <div
        className={`mb-20 w-5/6 mx-auto bg-gradient-to-bl from-card to-card/75 p-15 rounded-xl flex flex-col lg:flex-row items-center gap-10`}
      >
        <p
          className={`text-center lg:text-left text-4xl/15 text-card-foreground font-sans lg:w-7/12`}
        >
          Ready to work with the best teams?
        </p>
        <div className={`lg:w-5/12 flex items-center justify-center gap-5`}>
          ...
          <Button
            variant={`ghost`}
            size={`lg`}
            className={`cursor-pointer flex items-center gap-1.5 text-lg transition-all`}
          >
      ...
      <div
        className={`w-5/6 mx-auto flex flex-col lg:flex-row lg:justify-between mb-10 gap-20`}
      >
        <div className={`flex flex-col gap-3 text-center lg:text-left`}>
          <h1 className={`text-3xl font-semibold font-sans text-foreground`}>
            Connect
          </h1>
        ...
        <div
          className={`flex flex-col gap-10 lg:gap-0 lg:flex-row items-center justify-between lg:w-4/6 text-center lg:text-left`}
        >
          <div className={`flex flex-col gap-4`}>
            <p className={`text-lg font-sans text-white`}>Company</p>
            <div className={`flex flex-col gap-2.5`}>
              <p
                className={`text-base font-sans cursor-pointer hover:text-white transition-all text-foreground/95`}
              >
                About Us
              </p>
              <p
        ...
        <div
          className={`lg:w-1/6 flex items-center lg:items-start flex-col gap-2`}
        >
